...
| Skill | Description |
|-------|-------------|
| [commit-message](skills/commit-message/) | Generate commit messages in the strict semicolon-separated 5-line schema: first line is Jira key, then type, scope, summary, body. Aligned with Change log Process and n8n → Intercom. Use when the user or agent makes commits via Chat or when asked to suggest a commit message. |
